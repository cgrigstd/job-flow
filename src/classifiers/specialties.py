...
SPECIALTIES: list[Specialty] = [
    ...
    Specialty("audio_composer", "Music / Audio", [
        "compositor", "composer", "music producer",
    ...
    Specialty("video_production", "Video Production", [
        "video producer", "videographer", "director",
